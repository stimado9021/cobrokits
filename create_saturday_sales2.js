...
(async () => {
  ...
  // Update clients' visit_day to Saturday (6)
  await c.query("UPDATE customers SET visit_day = 6 WHERE name IN ('perencejo', 'fulanito')");
  console.log('Updated clients visit_day to Saturday (6)');
